...
(function () {
    ...
    const STYLE_HREF = "/assets/wmn/js/pos_offline/features/barcode_scan_quantity/barcode_scan_quantity.css";
    ...
    function ensureStylesheet() {
        ...
        link.id = STYLE_ID;
        link.rel = "stylesheet";
        const version = window.__wmn_pos_asset_version || "";
        link.href = STYLE_HREF + (version ? `?v=${encodeURIComponent(version)}` : "");
