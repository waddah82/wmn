...
(function () {
    ...
    function ensureStyles() {
        ...
        style.textContent = `
            ...
            .wmn-pos-doctype-dialog .modal-body > .form-layout,
            .wmn-pos-doctype-dialog .modal-body .form-page,
            .wmn-pos-doctype-dialog .modal-body .form-section,
            .wmn-pos-doctype-dialog .modal-body .section-body,
            .wmn-pos-doctype-dialog .modal-body .row,
            .wmn-pos-doctype-dialog .modal-body [class*="col-"],
            .wmn-pos-doctype-dialog .modal-body .form-column,
            .wmn-pos-doctype-dialog .modal-body .column-break,
            .wmn-pos-doctype-dialog .modal-body .frappe-control,
            .wmn-pos-doctype-dialog .modal-body .control-input-wrapper,
            .wmn-pos-doctype-dialog .modal-body .control-input,
            .wmn-pos-doctype-dialog .modal-body .control-value,
            .wmn-pos-doctype-dialog .modal-body [data-fieldname="doctype_html"] {
            ...
            .wmn-pos-doctype-dialog .modal-body .section-body > .row {
            ...
            body.wmn-mamsek-pos-route .wmn-pos-doctype-shell { display: flex; flex-direction: column; height: 100%; width: 100%; min-height: 0; background: var(--subtle-fg, #f8fafc); }
            ...
            body.wmn-mamsek-pos-route .wmn-pos-doctype-frame-wrap { position: relative; flex: 1 1 auto; min-height: 0; overflow: hidden; background: #f4f6f8; }
            body.wmn-mamsek-pos-route .wmn-pos-doctype-frame { width: 100%; height: 100%; border: 0; background: #fff; }
    ...
    function configureDoctypeDialogLayout(dialog) {
        ...
        const modalBodyElement = $modalBody.get(0);
        ...
        applyImportant($wrapper.find(".modal-dialog").get(0), {
            width: "96vw",
            "max-width": "1480px",
            height: "94vh",
            margin: "3vh auto",
        });
        applyImportant($wrapper.find(".modal-content").get(0), {
            width: "100%",
            "max-width": "none",
            height: "94vh",
            "max-height": "94vh",
        ...
        applyImportant(modalBodyElement, {
            width: "100%",
            "max-width": "none",
            "min-width": "0",
            "min-height": "0",
        ...
        while (node && node !== modalBodyElement) {
            applyImportant(node, {
                "box-sizing": "border-box",
                width: "100%",
                "max-width": "none",
        ...
        $modalBody.find(
            '.form-layout, .form-page, .form-section, .section-body, .row, [class*="col-"], .form-column, .column-break, .frappe-control, .control-input-wrapper, .control-input, .control-value, [data-fieldname="doctype_html"]'
        ).each((_, element) => {
        ...
        $modalBody.find(".section-body > .row").each((_, element) => {
            applyImportant(element, {
                display: "flex",
                "flex-wrap": "nowrap",
                width: "100%",
