...
set_pos_profile_data() {
                ...
                this.recent_order_list = new erpnext.PointOfSale.PastOrderList({
                    ...
                    events: {
                        open_invoice_data: (doctype, name) => {
                            // ERPNext v16 sends (doctype, name). Older builds may send only (name).
                            if (!name) {
                                name = doctype;
                                doctype = wmn_pos_invoice_doctype(this);
                            }
                            doctype = doctype || wmn_pos_invoice_doctype(this);
            ...
            init_order_summary() {
                const default_doctype = this.settings.as_sales_invoice === 1  ? "Sales Invoice" : "POS Invoice";
                this.settings = wmn_safe_settings(this.settings || {});
                this.order_summary = new erpnext.PointOfSale.PastOrderSummary({
                    ...
                    events: {
                        ...
                        process_return: (doctype, name) => {
                            ...
                            doctype = doctype || default_doctype;
                        ...
                        delete_order: (doctype, name) => {
                            ...
                            doctype = doctype || this.frm.doc.doctype;
